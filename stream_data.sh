...
SCRIPT_1="$SCRIPT_DIR/src/hand_tracking/mediapipe_server.py"
SCRIPT_2="$SCRIPT_DIR/src/hand_tracking/mediapipe_client.py"
SCRIPT_3="$SCRIPT_DIR/src/openbci/brainflow_server.py" 
